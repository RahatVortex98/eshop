# Generated by Django 5.1.6 on 2025-02-26 02:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_amount', models.DecimalField(decimal_places=3, max_digits=7)),
                ('payment_status', models.CharField(choices=[('PAID', 'Paid'), ('UNPAID', 'Unpaid')], default='UNPAID', max_length=20)),
                ('oreder_status', models.CharField(choices=[('Processing', 'Processing'), ('Shipped', 'Shipped'), ('Delivered', 'Delivered')], default='Processing', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(blank=True, decimal_places=3, max_digits=7)),
